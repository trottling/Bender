...
def ConnectScannerSignals(self):
    ...
    self.scanner.label_System_image_setStyleSheet_signal.connect(lambda item: self.ui.label_System_image.setStyleSheet(".QLabel {image: url('" + GetRelPath(self, r"assets\\images\\" + item + "')}")))
    ...
    self.scanner.frame_sys_bitness_setStyleSheet_signal.connect(lambda item: self.ui.frame_sys_bitness.setStyleSheet(".QFrame {image: url('" + GetRelPath(self, item) + "')}"))
    ...
    self.scanner.FillDriversList_signal.connect(lambda item: FillDriversList(item))
    self.scanner.ReportDrivers_signal.connect(lambda item: ReportDrivers(self, item))
    self.scanner.FillKBList_signal.connect(lambda item: FillKBList(self, item))
