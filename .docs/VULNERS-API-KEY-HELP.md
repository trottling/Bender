...
3. Check KEY by press on check button which is to the right of the key field, if you received successful key verification, everything is ready for scanning, if not - go back to step 1 and repeat everything again.
